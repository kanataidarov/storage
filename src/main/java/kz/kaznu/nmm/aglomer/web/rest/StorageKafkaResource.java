...
@RestController
@RequestMapping("/api/storage-kafka")
public class StorageKafkaResource {

    private final Logger log = LoggerFactory.getLogger(StorageKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public StorageKafkaResource(KafkaProperties kafkaProperties) {
