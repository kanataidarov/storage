...
@Service
@Transactional
public class RecordValueServiceImpl implements RecordValueService {

    private final Logger log = LoggerFactory.getLogger(RecordValueServiceImpl.class);
    ...
    public RecordValueServiceImpl(RecordValueRepository recordValueRepository, RecordValueMapper recordValueMapper, RecordValueSearchRepository recordValueSearchRepository) {
