...
public class RecordFieldServiceImpl implements RecordFieldService {
    ...
    private final Logger log = LoggerFactory.getLogger(RecordFieldServiceImpl.class);
    ...
    public RecordFieldServiceImpl(RecordFieldRepository recordFieldRepository, RecordFieldMapper recordFieldMapper, RecordFieldSearchRepository recordFieldSearchRepository) {
